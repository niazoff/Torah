...
public extension ReadingFactory {
  static func makeReading(for parshah: ParshahIdentifier) -> Reading {
    ParshahReading(identifier: parshah, aliyahs: makeAliyahs(for: parshah))
  }
